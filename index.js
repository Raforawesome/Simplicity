...
const ksoft = new KSoftClient('7ff810599f061e6896d6caac50795528f378ad75');
...
client.login('NzAyNzY2MTU0NjMyMTM0Njc2.XqEz_A.1tqT-Dzs8WUmTlPevEwl-9mRoKc');
...
client.on('ready', () => {
    client.channels.fetch('795437788547383339').then(channel => slogChannel = channel)
    client.channels.fetch('866849002317545493').then(channel => jlogChannel = channel)
    client.channels.fetch('866849040636575744').then(channel => mlogChannel = channel)
